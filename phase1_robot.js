/*
Most of the code has been discussed in the book so taken from there itself
*/
const roads = [
...
function runRobot(state, robot, memory) {
    ...
    for (let turn = 0;; turn++) {
        if (state.parcels.length == 0) {
            console.log(`Moves made by robot:\n[${movements}]`)
        ...
        movements.push(action.direction);
    }
}
...
//Comapring Efficieny - Basically Just Average Steps
